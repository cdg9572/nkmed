...
$GP -> MENU_ADMIN = array(
		...
		array("tab"=>"14",			"folder"=>"slidem", 			"name"=>"슬라이드관리",		"link"=> "/admin/slidem/slide_PC_list.php?m_tab=14"),		
        ...
        // array("tab"=>"15",			"folder"=>"schedule", 		"name"=>"검진예약 스케줄 관리",			"link"=> "/admin/schedule/schedule.php?m_tab=15"),		     
		array("tab"=>"11",			"folder"=>"medicalcheckup", 		"name"=>"건강검진관리",			"link"=> "/admin/medicalcheckup/medicalcheckup_list.php?m_tab=11"),
        array("tab"=>"12",			"folder"=>"video", 		"name"=>"동영상관리",			"link"=> "/admin/video/vd_list.php?m_tab=12"),
        array("tab"=>"13",			"folder"=>"conversion", 		"name"=>"전환율",				"link"=> "/admin/conversion/location.php?m_tab=13")
...
$GP -> MENU_SUB_ADMIN['medicalcheckup'] = array(
	"건강검진관리"   => array(
		array("tab"=>"1",	"title"=>"medicalcheckup1",		"name"=>"건강검진 관리",			"link"=>  "/admin/medicalcheckup/medicalcheckup_list.php"),
        array("tab"=>"2",	"title"=>"medicalcheckup2",	"name"=>"검진예약 스케줄 관리",				"link"=>  " /admin/medicalcheckup/schedule.php")
		/*array("tab"=>"2",		"name"=>"비급여 카테고리",			"link"=>  "/admin/nonpay/cate_list.php"),*/
	)
);
...
$GP -> MENU_SUB_ADMIN['schedule'] = array(
	"예약 스케줄 관리"   => array(
		array("tab"=>"1",	"title"=>"schedule1",		"name"=>"예약 스케줄 관리",			"link"=>  "/admin/schedule/schedule.php"),
...
$GP -> MENU_SUB_ADMIN['popup'] = array(
	"팝업관리"   => array(
        array("tab"=>"1",		"name"=>"팝업 PC",				"link"=>  "/admin/popup/popup_list.php"),
        array("tab"=>"2",		"name"=>"팝업 모바일",				"link"=>  "/admin/popup/popup_mobile_list.php"),
	)
);

$GP -> MENU_SUB_ADMIN['slidem'] = array(
	"슬라이드관리"   => array(
        array("tab"=>"1",	"title"=>"slide1",		"name"=>"PC 탑배너",			"link"=>  "/admin/slidem/slide_PC_list.php"),
        array("tab"=>"2",	"title"=>"slide2",		"name"=>"PC 메인슬라이드",			"link"=>  "/admin/slidem/slide_main_list.php"),		
		array("tab"=>"3",	"title"=>"slide3",		"name"=>"모바일 슬라이드",			"link"=>  "/admin/slidem/slide_list.php"),
	)
);
...
$GP -> MENU_SUB_ADMIN['phone'] = array(
	"모바일 온라인예약"   => array(
		array("tab"=>"1",	"title"=>"phone1",	"name"=>"간편예약 관리",				"link"=>  "/admin/phone/phone_list.php")       
