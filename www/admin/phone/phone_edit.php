    ...
    <input type="hidden" name="tfc_idx" id="tfc_idx" value="<?=$_GET['tfc_idx']?>" />
		<div class="boxContentBody">
			...
			<tr>
				<th><span>*</span>구분</th>
				<td>
					<input type="radio" name="tfc_type" value="A" <? if($tfc_type == "A"){ echo "checked"; }?> />일반문의
					<input type="radio" name="tfc_type" value="B" <? if($tfc_type == "B"){ echo "checked"; }?> />예약문의
				</td>
			</tr>		
            <tr class="row">
            ...
            <tr class="row">
                ...
                <td>
                  <textarea name="tfc_result_con" id="tfc_result_con" style="width:700px; height:100px;"><?=$tfc_result_con?></textarea>
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
        ...
        // console.log($('#tfc_result_con').val());
