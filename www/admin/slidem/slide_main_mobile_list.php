...
<div class="Wrap"><!--// 전체를 감싸는 Wrap -->
		...
		<button onClick="layerPop('ifm_reg','./slide_main_reg.php', '100%', 650)"; class="btnSearch ">슬라이드 등록</button>
		</div>
							...
							<?
								...
								if($data_list_cnt > 0 ) {
									for ($i = 0 ; $i < $data_list_cnt ; $i++) {
										...
										$m_img = '';
										if($ts_img !=  '') {
											$m_img = "<img src='" . $GP -> UP_SLIDE_URL . $ts_img . "' width='100px' />";
										}else {
											$m_img = "<img src='/images/no_image.jpg' width='100px' />";
										}
	
										$edit_btn = $C_Button -> getButtonDesign('type2','수정',0,"layerPop('ifm_reg','./slide_main_edit.php?ts_idx=" . $ts_idx. "', '100%', 650)", 50,'');	
