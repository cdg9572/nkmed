...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
		...
		<input type="hidden" name="ts_type" id="ts_type" value="main" />
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<th><span>*</span>제목</th>
								<td>                                   
                                    <textarea name="ts_title" id="ts_title" style="width:98%; height:70px;  overflow:auto;" ></textarea>
								</td>
							</tr>							
							<tr>
								<th><span>*</span>내용</th>
                            ...
                            <tr>
								<th><span>*</span>링크</th>
								<td>
									<input type="text" class="input_text" size="50" name="ts_link" id="ts_link" />
							...
							<tr>
								...
								<td>
									<input type="file" name="ts_m_img" id="ts_m_img" size="30" class="input_text">
								</td>
							</tr>
						</tbody>
					</table>
