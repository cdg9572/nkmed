				...
				<table class="table table-bordered">
					<tbody>		
						...
						<tr class="row">
								...
								<td >
										<input type="text" class="input_text" size="25" name="tor_rs_time" id="tor_rs_time" value="<?=substr($tor_rs_time, 0, 2) . ":" . substr($tor_rs_time, 2, 2)?>" />
								</td>
						</tr>
						<tr class="row">
						...
						<tr class="row">
								<th scope="row"><span class="star">*</span>메모</th>
								<td><?=$tor_rs_content?></td>
						</tr>
						<!-- tr class="row">
