						...
						<tbody>
							<?
								...
								for ($i = 0 ; $i < $data_list_cnt ; $i++) {
									...
									$tor_rs_time = substr($tor_rs_time, 0, 2) . ":" . substr($tor_rs_time, 2, 2);
									...
									$edit_btn = $C_Button -> getButtonDesign('type2','상세보기',0,"layerPop('ifm_reg','./online_reserve_edit.php?tor_idx=" . $tor_idx. "', '100%', 700)", 50,'');	
