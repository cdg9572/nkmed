...
<div class="Wrap_layer"><!--// 전체를 감싸는 Wrap -->
	<div class="boxContent_layer">
        ...
        <input type="hidden" name="before_image_new" id="before_image_new" value="<?=$dr_new_img?>" />
			...
			<div class="boxMemberInfoTable_layer">
				<table class="table table-bordered">
					<tbody>
                        ...
                        <tr>
							<th><span>*</span>뉴 이미지<br/></th>
							<td>
								<input type="file" name="dr_new_img" id="dr_new_img" size="30">
								<?
									if($dr_new_img != "") {
										echo  "<br>" . $dr_new_img;
								?>
									<a href="#" onClick="img_del('<?=$dr_new_img?>','<?=$_GET['dr_idx']?>','I')">(X)</a>
								<? } ?>
							</td>
						</tr>
						<tr>
                        ...
                        <tr>
							<th><span>*</span>검색 키워드</th>
							<td>
								<textarea name="dr_book" id="dr_book" style="width:98%; height:50px;" ><?=$dr_book?></textarea>
							</td>
						</tr>
