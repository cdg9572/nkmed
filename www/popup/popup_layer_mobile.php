...
<script type="text/javascript">
	...
	<div id="divpop_<?=$pop_idx?>" class="popup-layer" style="width:100%;position:absolute; left:0px; top:<?=$pop_y_position?>px;  z-index:10000; visibility: hidden; overflow:<?=$scrollbars?>;">
  <form name="Pop_form_<?=$pop_idx?>">
    ...
    <div style="height:30px;padding:5px;background:#000;font-size:14px; color:#FFFFFF;">
      <input name="chkbox" type="checkbox" value="1" /> 이 창을 <?=$cookie_text?> 열지 않습니다.
      <a href="javascript:closeWin_<?=$pop_idx?>();" style="float:right;color:#fff;font-weight:bold;">[닫기]</a> 
    </div> 
  </form>     
  </div> 
	<style type="text/css">
