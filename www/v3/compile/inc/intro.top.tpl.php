<?php /* Template_ 2.2.8 2023/08/02 17:35:18 /home/hosting_users/nkmed/www/v3/view/inc/intro.top.tpl 000001473 */ ?>
<div class="subTop3">
    ...
    <nav class="location">
        ...
        <div class="depth3">
            ...
            <ul class="list" id="intro_menu">
				...
				<li><a href="?tab=intro7" data-page="intro7">HI소개</a></li>
                <li><a href="?tab=intro3" data-page="intro3">연혁</a></li>
                <li><a href="?tab=intro4" data-page="intro4">미션,비젼,가치</a></li>
                <li><a href="?code=100&tab=intro5&idx=top" data-page="intro5">채용정보</a></li>
