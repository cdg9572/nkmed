<?php /* Template_ 2.2.8 2023/11/29 12:01:38 /home/hosting_users/nkmed/www/v3/view/center.tpl 000009712 */ 
...
<hr>
	<div class="section">
        <div class="tabMenu">
            <ul id="vod_gubun">
<?php if($TPL_VAR["depart"]=="J"){?>
                <li  <?php echo $TPL_VAR["active1"]?> data-gubun="C"><a href="javascript:void(0)"><span>이용안내</span></a></li>
<?php }else{?>
				<li  <?php echo $TPL_VAR["active1"]?> data-gubun="C"><a href="javascript:void(0)"><span>질환정보</span></a></li>
<?php }?>
                <li  <?php echo $TPL_VAR["active2"]?> data-gubun="D"><a href="javascript:void(0)"><span>질환영상</span></a></li>
            </ul>
        </div>
