<?php /* Template_ 2.2.8 2023/10/31 16:11:46 /home/hosting_users/nkmed/www/v3/view/info/info17_1_5.tpl 000024815 */ ?>
<style>
	.tabMenu.drop {
		position: relative;
...
<div class="section">
	...
	<h3 class="cont-tit"><small>행복형 검진 프로그램 <i>기본종합검진 + A선택검사 4종류 + C선택검사 1종류 <br> A선택검사 2종류 + B선택검사 1종류 + C선택검사 1종류</i></small></h3>
    <form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
        ...
        <input type="hidden" name="tm_type" id="tm_type" value="E"  />                             
        ...
        <input type="hidden" name="tm_content4" id="tm_content4" />                
        <input type="hidden" name="tm_content12" id="tm_content12" />          
        <input type="hidden" name="page_link" id="page_link" value="/v3/info.php?tab=info17_1_5" />
		...
		<table>
				...
				<tr class="gender">
                   ...
                   <div class="check-box m on" id="checkbox1">
                    ...
                    <div class="check-box w" id="checkbox2">   
                        ...
                        <label for="check5_4"><input type="checkbox" name="tm_checkbox2" id="check5_4" value="대장[수면]내시경"> 대장[수면]내시경</label>
                        <label for="check5_5"><input type="checkbox" name="tm_checkbox2" id="check5_5" value="얼리텍[분변]-대장암"> 얼리텍[분변]-대장암</label>    
                        <label for="check5_6"><input type="checkbox" name="tm_checkbox2" id="check5_6" value="유방초음파"> 유방초음파</label>                                    
                    </div>
					</td>
				</tr>
				<tr>
			...
			<tfoot>
				<tr class="gender">
					<th colspan="2">
						총 검진 비용 
						<span class="m on">810,000원</span>
						<span class="w">860,000원</span>
					</th>
				</tr>
			</tfoot>
		</table>
    ...
    $(document).ready(function() {           
           ...
           $('input[name="tm_checkbox1"]').click(function() {
               ...
               if (selectedValues.length === 2) {                    
                   ...
                   $("#" + parentId + " input[name='tm_checkbox3']").prop("disabled", true);
       ...
       $("#service_submit").click(function(){				
           ...
           if (tm_count2.trim() !== '') {
               itemCount2 = tm_count2.split(',');
           }

           if (tm_count3.trim() !== '') {
               itemCount3 = tm_count3.split(',');
           }
           ...
           if (tm_count.length != 2 && tm_count.length != 4) {
			...
			if (tm_count.length == 2 && itemCount2.length != 1) {
                 alert("B검사를 정확히 선택하세요.");
                 return false;
            }  

           if (tm_count.length == 2 && itemCount2.length == 1 && itemCount3.length != 1) {
