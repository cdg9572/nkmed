<?php /* Template_ 2.2.8 2023/08/21 13:33:41 /home/hosting_users/nkmed/www/v3/view/info/info17_2_1.tpl 000002958 */ ?>
<style>
	.tabMenu.drop {
		position: relative;
...
<div class="section">
	...
	<h3 class="cont-tit"><small>결과 확인</small></h3>
	...
	<div class="btnWrap">
		<span><a href="https://nkhospital.net/v3/info.php?tab=info17_2" class="btnType2">확인</a></span>
	</div>
	<br>
	<div class="grayBox text-left">
		<ul>
			<li class="starTxt">뉴고려병원 건강검진 프로그램은 예약제입니다.</li>
			<li class="starTxt">홈페이지나 상담전화를 이용하여 미리 예약하십시오. <br>(평생건강증진센터 1933-9988)</li>
		</ul>
	</div>
</div>