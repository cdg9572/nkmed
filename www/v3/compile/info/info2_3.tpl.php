<?php /* Template_ 2.2.8 2023/08/04 14:57:28 /home/hosting_users/nkmed/www/v3/view/info/info2_3.tpl 000003332 */ ?>
...
<div class="section">
	...
	<table class="lineTable">
		...
		<tbody>
			...
			<tr>
				<td>환자정보</td>
				<td class="right"><?php echo $TPL_VAR["suserpatientno"]?></td>
			</tr>
			<tr>
				<td>휴대전화</td>
	...
	<table class="lineTable">
		...
		<tbody>
			<tr>
				<td>진료과</td>
				<td class="right"><?php echo $TPL_VAR["clinic_str"]?></td>
			</tr>
			<tr>
				<td>의료진</td>
				<td class="right"><?php echo $TPL_VAR["dr_name"]?> <?php echo $TPL_VAR["dr_position"]?></td>
			</tr>
			<tr>
				<td>예약일시</td>
				<td class="right">
                <?php echo $TPL_VAR["is_date"]?><?php echo $TPL_VAR["is_time"]?>
	...
	<div class="btnWrap">
		...
		<span>
			<a href="#none" class="btnType3" onclick="online_delete(<?php echo $TPL_VAR["first_no"]?>)">예약취소</a>
		</span>
	</div>
</div>
