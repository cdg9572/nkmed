<?php /* Template_ 2.2.8 2023/10/31 16:10:16 /home/hosting_users/nkmed/www/v3/view/info/info17_1_4.tpl 000022930 */ ?>
<style>
	.tabMenu.drop {
		position: relative;
...
<div class="section">
	...
	<h3 class="cont-tit"><small>믿음형 검진 프로그램 <i>기본종합검진 + 대장 내시경 + A선택검사 4종류 <br> A선택검사 2종류 + B선택검사 1종류 <br> C선택검사 1종류</i></small></h3>
    <form name="base_form" id="base_form" method="POST" action="?" enctype="multipart/form-data">
        ...
        <input type="hidden" name="tm_type" id="tm_type" value="D"  />                             
        ...
        <input type="hidden" name="tm_content4" id="tm_content4" value="대장내시경"/>                
        <input type="hidden" name="tm_content12" id="tm_content12" />               
        <input type="hidden" name="page_link" id="page_link" value="/v3/info.php?tab=info17_1_4" />
	<div class="tableType1">
		<table>
			...
			<tbody>
				...
				<tr>
					<th colspan="2">기본옵션</th>
				</tr>
				<tr>
					<td colspan="2">
						<div class="check-box" style="margin:0 auto;">
							<!-- 항상 체크 되어 있게 해주세요. -->
							<label for="check4"><input type="checkbox" name="" id="check4" checked> 대장내시경</label>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center">택4 or 택2 or 택0</td>
				</tr>
				<tr class="gender">
					<td colspan="2">
				...
				<tr class="gender">
					<td colspan="2">
                        ...
                        <div class="check-box w" id="checkbox2">
                            <label for="check5_1"><input type="checkbox" name="tm_checkbox2" id="check5_1" value="심장초음파"> 심장초음파</label>
                            <label for="check5_2"><input type="checkbox" name="tm_checkbox2" id="check5_2" value="알레르기=음식+호흡(91종)"> 알레르기=음식+호흡(91종)</label>
                            <label for="check5_3"><input type="checkbox" name="tm_checkbox2" id="check5_3" value="부정맥 검사[S-Patch]"> 부정맥 검사[S-Patch]</label>
                            <label for="check5_4"><input type="checkbox" name="tm_checkbox2" id="check5_4" value="유방초음파"> 유방초음파</label>
                        </div>
					</td>
				</tr>
				<tr>
				...
				<tr class="gender">
					<td colspan="2">
                        <div class="check-box m on" id="checkbox1"> 
                            <label for="check3_1"><input type="checkbox" name="tm_checkbox3" id="check3_1" value="뇌MRA + MRI"> 뇌MRA + MRI</label>
                            <label for="check3_2"><input type="checkbox" name="tm_checkbox3" id="check3_2" value="경추MRI"> 경추MRI</label>
                            <label for="check3_3"><input type="checkbox" name="tm_checkbox3" id="check3_3" value="요추MRI"> 요추MRI</label>
                            <label for="check3_4"><input type="checkbox" name="tm_checkbox3" id="check3_4" value="스마트암(남6종/여7종)"> 스마트암(남6종/여7종)</label>
                            <label for="check3_5"><input type="checkbox" name="tm_checkbox3" id="check3_5" value="선천적 유전자검사(남34종/여35종)"> 선천적 유전자검사(남34종/여35종)</label>
                        </div>
                        <div class="check-box w" id="checkbox2"> 
                            <label for="check6_1"><input type="checkbox" name="tm_checkbox3" id="check6_1" value="뇌MRA + MRI"> 뇌MRA + MRI</label>
                            <label for="check6_2"><input type="checkbox" name="tm_checkbox3" id="check6_2" value="경추MRI"> 경추MRI</label>
                            <label for="check6_3"><input type="checkbox" name="tm_checkbox3" id="check6_3" value="요추MRI"> 요추MRI</label>
                            <label for="check6_4"><input type="checkbox" name="tm_checkbox3" id="check6_4" value="스마트암(남6종/여7종)"> 스마트암(남6종/여7종)</label>
                            <label for="check6_5"><input type="checkbox" name="tm_checkbox3" id="check6_5" value="선천적 유전자검사(남34종/여35종)"> 선천적 유전자검사(남34종/여35종)</label>                            
                        </div>
					</td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="gender">
					<th colspan="2">
						총 검진 비용 
						<span class="m on">690,000원</span>
						<span class="w">740,000원</span>
					</th>
				</tr>
			</tfoot>
		</table>
        ...
        $(document).ready(function() {  
            ...
            $('input[name="tm_title"]').click(function() {
                ...
                if(value == "남"){
                    ...
                    $("#checkbox1 input[name^='tm_checkbox']").prop("disabled", true);
                     //checkbox2 tm_checkbox4 checked
            ...
            $('input[name="tm_checkbox1"]').click(function() {
				...
				if(selectedValues.length > 0){
					...
					$('input[name="tm_checkbox3"]').prop("disabled", false);
				}	
            });
			$('input[name="tm_checkbox3"]').click(function() { 
				var selectedValues3 = [];
				...
				//tm_checkbox3 체크되어 있으면 tm_checkbox1,tm_checkbox2 비활성화 아니면 활성화
				if(selectedValues3_length.length > 0){
					$('input[name="tm_checkbox1"]').prop("disabled", true);
				}
				else{
					$('input[name="tm_checkbox1"]').prop("disabled", false);
				}				
			});
