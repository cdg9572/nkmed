...
<div class="searchResult">
        ...
        <ul class="docList2" id="doctor_result" data-total="{dcnt}">
            ...
            <li data-page='{.p}' {.style}>
                <a href="/v3/detail.php?idx={.dr_idx}&gubun=D">
                    ...
                    <span class="name"><span>{.treat} {.treat2}</span> {.dr_name} {.dr_ps}</span>
    ...
    <!--{?list4}-->
    <div class="section">
        <h3 class="subTitle">전문센터 <span class="sub">({dp1cnt}건)</span></h3>
        <ul class="boardThumb" id="board_result" data-total="{dp1cnt}">
			<!--{@list4}-->        
            <li class="panel" data-group=""><a href="{.dp_link}"><img src="{.dp_img}" alt="">{.dp_name}</a></li>
            <!--{/}-->
        </ul>
        <div class="btnWrap"{dp1mbtn}>
	...
	<!--{/}-->
     <!--{?list5}-->
     <div class="section">
        <h3 class="subTitle">진료과 <span class="sub">({dp2cnt}건)</span></h3>
        <ul class="boardThumb" id="board_result" data-total="{dp2cnt}">
			<!--{@list5}-->        
            <li class="panel" data-group=""><a href="{.dp_link}"><img src="{.dp_img}" alt="">{.dp_name}</a></li>
            <!--{/}-->
        </ul>
	...
	<!--{/}-->
     <!--{?list6}-->
     <div class="section">
        <h3 class="subTitle">특수클리닉 <span class="sub">({dp3cnt}건)</span></h3>
        <ul class="boardThumb" id="board_result" data-total="{dp3cnt}">
			<!--{@list6}-->        
            <li class="panel" data-group=""><a href="{.dp_link}"><img src="{.dp_img}" alt="">{.dp_name}</a></li>
            <!--{/}-->
        </ul>
