...
<hr>
	<div class="section">
        <div class="tabMenu">
            <ul id="vod_gubun">
				{?depart=="J"}
                <li  {active1} data-gubun="C"><a href="javascript:void(0)"><span>이용안내</span></a></li>
				{:}
				<li  {active1} data-gubun="C"><a href="javascript:void(0)"><span>질환정보</span></a></li>
				{/}
                <li  {active2} data-gubun="D"><a href="javascript:void(0)"><span>질환영상</span></a></li>
            </ul>
        </div>
		<!--{?list4}-->
