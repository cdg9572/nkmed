...
if($depart =='H'  || $depart =='I' ||$depart == 'AJ' || $depart =='M' || $depart =='W' ||$depart == 'AH' || $depart =='R' || $depart =='Q' || $depart =='AI'  || $depart =='J'){
    $active1 = "class='active'" ;
    echo "<script>$(document).ready(function(){ $('#board_result').show();$('#vod_result').hide();});</script>";  
}
else{
			...
			for($i=0;$i<count($bdata);$i++) {
				...
				foreach($data as $k=>$v){ 
					...
					if($depart == "AC")
                        ...
                        $treat = ($GP->NEW_MOBILE_CENTER_ALL[$val["dr_clinic2"]]) ? $GP->NEW_MOBILE_CENTER_ALL[$val["dr_clinic2"]] : $GP->NEW_MOBILE_CENTER_ALL[$val["dr_clinic3"]];
                        $treat_text = "<h3 class='title'>$ctxt<span>($treat)</span></h3>";
						}
                    ...
                    if(in_array("월", $moning_arr)){$moning_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$moning_txt .= "<td>수술</td>";}
                    else{$moning_txt .= "<td>-</td>";}

                    if(in_array("화", $moning_arr)){$moning_txt .= "<td>진료</td>";}
                    else if($dr_idx == "55" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$moning_txt .= "<td>수술</td>";}
                    else{$moning_txt .= "<td>-</td>";}

                    if(in_array("수", $moning_arr)){$moning_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$moning_txt .= "<td>수술</td>";}
                    else{$moning_txt .= "<td>-</td>";}

                    if(in_array("목", $moning_arr)){$moning_txt .= "<td>진료</td>";}
                    else if($dr_idx == "55" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$moning_txt .= "<td>수술</td>";}
                    else{$moning_txt .= "<td>-</td>";}

                    if(in_array("금", $moning_arr)){$moning_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$moning_txt .= "<td>수술</td>";}
                    else{$moning_txt .= "<td>-</td>";}

                    if(in_array("월", $after_arr)){$after_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$after_txt .= "<td>수술</td>";}
                    else{$after_txt .= "<td>-</td>";}

                    if(in_array("화", $after_arr)){$after_txt .= "<td>진료</td>";}
                    else if($dr_idx == "55" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$after_txt .= "<td>수술</td>";}
                    else{$after_txt .= "<td>-</td>";}

                    if(in_array("수", $after_arr)){$after_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$after_txt .= "<td>수술</td>";}
                    else{$after_txt .= "<td>-</td>";}

                    if(in_array("목", $after_arr)){$after_txt .= "<td>진료</td>";}
                    else if($dr_idx == "55" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$after_txt .= "<td>수술</td>";}
                    else{$after_txt .= "<td>-</td>";}

                    if(in_array("금", $after_arr)){$after_txt .= "<td>진료</td>";}
                    else if($dr_idx == "138" or $dr_idx == "62" or $dr_idx == "95" or $dr_idx == "150" or $dr_idx == "155"){$after_txt .= "<td>수술</td>";}
                    else{$after_txt .= "<td>-</td>";}
