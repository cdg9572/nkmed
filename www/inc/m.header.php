<div id="nav">
	...
	<div class="group">
		...
		<div class="panel">
			<ul class="list">
				<li class="dp1"><a href="/m/main.html"><span>메인으로</span></a></li>
				<li class="dp1">
					<a href="javascript:void(0)"><span>진료예약</span><i class="ip-icon-arrow-down"></i></a>
					<div class="dp-section">
						<ul>
							<li class="dp2"><a href="res.process.01.html?ptype=s"><!--a href="javascript:alert('시스템 점검중입니다.콜센터로 전화 부탁 드립니다.')"--><span>본인예약</span></a></li>
