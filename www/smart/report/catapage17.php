...
<body>
<div data-role="page" id="cataPage17">
...
<div data-role="content" class="cataBG_17">
		<div class="banner"></div>
		<h2 class="h2_title">요검사</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata17-01" data-ajax="false">신장질환</a></li>
                </ul>
            </div>
            <div id="cata17-01" data-inset="true" class="comentBox">
				<div>
