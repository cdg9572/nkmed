...
<body>
<div data-role="page" id="cataPage08">
...
<div data-role="content" class="cataBG_29">
		<div class="banner"></div>
		<h2 class="h2_title">혈액검사</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata29-01" data-ajax="false">빈혈</a></li>
                    <li><a href="#cata29-02" data-ajax="false">당뇨병</a></li>
					<li><a href="#cata29-03" data-ajax="false">이상지질혈증</a></li>
					<li><a href="#cata29-04" data-ajax="false">신장</a></li>
					<li><a href="#cata29-05" data-ajax="false">간장</a></li>
                </ul>
            </div>
            <div id="cata29-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata29-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata29-03" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata29-04" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata29-05" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
