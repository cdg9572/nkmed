...
<body>
<div data-role="page" id="cataPage21">
...
<div data-role="content" class="cataBG_21">
		<div class="banner"></div>
		<h2 class="h2_title">위암 검진결과</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata21-01" data-ajax="false">위내시경</a></li>
                    <li><a href="#cata21-02" data-ajax="false">심전도</a></li>
                </ul>
            </div>
            <div id="cata21-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata21-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
