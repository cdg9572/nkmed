...
<body>
<div data-role="page" id="cataPage16">
...
<div data-role="content" class="cataBG_16">
		<div class="banner"></div>
		<h2 class="h2_title">계측검사</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata16-01" data-ajax="false">비만</a></li>
                    <li><a href="#cata16-02" data-ajax="false">고혈압</a></li>
					<li><a href="#cata16-03" data-ajax="false">시각</a></li>
					<li><a href="#cata16-04" data-ajax="false">청각</a></li>
                </ul>
            </div>
            <div id="cata16-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata16-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata16-03" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata16-04" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
