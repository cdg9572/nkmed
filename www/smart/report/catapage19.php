...
<body>
<div data-role="page" id="cataPage19">
...
<div data-role="content" class="cataBG_19">
		<div class="banner"></div>
		<h2 class="h2_title">진찰 문진표</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata19-01" data-ajax="false">과거병력</a></li>
                    <li><a href="#cata19-02" data-ajax="false">생활습관</a></li>
					<li><a href="#cata19-03" data-ajax="false">일반상태</a></li>
                </ul>
            </div>
            <div id="cata19-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata19-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata19-03" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
