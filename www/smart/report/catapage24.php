...
<body>
<div data-role="page" id="cataPage24">
...
<div data-role="content" class="cataBG_24">
		<div class="banner"></div>
		<h2 class="h2_title">유방암 검진결과</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata24-01" data-ajax="false">방사선 유방촬영 검사</a></li>
                </ul>
            </div>
            <div id="cata24-01" data-inset="true" class="comentBox">
				<div>
