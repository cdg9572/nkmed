...
<body>
<div data-role="page" id="cataPage18">
...
<div data-role="content" class="cataBG_18">
		<div class="banner"></div>
		<h2 class="h2_title">영상</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata18-01" data-ajax="false">폐결핵</a></li>
                    <li><a href="#cata18-02" data-ajax="false">흉부질환</a></li>
                </ul>
            </div>
            <div id="cata18-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata18-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
