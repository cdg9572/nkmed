...
<body>
<div data-role="page" id="cataPage20">
...
<div data-role="content" class="cataBG_20">
		<div class="banner"></div>
		<h2 class="h2_title">건강위험 평가결과</h2>

		<!--horizontal navigation tab start-->
        <div data-role="tabs" id="tabs">
            <div data-role="navbar">
                <ul>
                    <li><a class="ui-btn-active" href="#cata20-01" data-ajax="false">알아보기</a></li>
                    <li><a href="#cata20-02" data-ajax="false">조절하기</a></li>
					<li><a href="#cata20-03" data-ajax="false">인지기능장애</a></li>
                </ul>
            </div>
            <div id="cata20-01" data-inset="true" class="comentBox">
				<div>
            ...
            <div id="cata20-02" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
			...
			<div id="cata20-03" data-inset="true" class="comentBox">
				<div>
					<h3>판정내용 <i class="fa fa-commenting fa-2x"></i></h3>
					<p>[ AA ] 정상입니다.</p>
				</div>
