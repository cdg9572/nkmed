...
<form action="http://www.smsfly.co.kr/outside/asp_sms_send.php" method="post" name="sendSMS3" target='smsifr2'>
...
<iframe id='smsifr2'  name='smsifr2' style='displaye:none;' width='100' height='100' ></iframe>
<?
//exit;
?>

<script>
		document.sendSMS3.submit() ; 
</script>