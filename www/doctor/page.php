...
if($chkMobile) $C_Func -> go_url ("/v3/center.info.php");
...
if($gubun == "A") {
    ...
    $arr = $GP -> NEW_MOBILE_ALL;
    $activeD = "active";
}

$dep1 = "1";
$dep2 = "1-3";
	if($gubun=="A"){ $dep3 = "1-3-1";}
    elseif($gubun=="B"){ $dep3 = "1-3-2";}
	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="innerCont">
				<div class="tabMenu">
					<ul>
						<li class="<?=$activeD?>"><a href="/doctor/page05.html" >의료진 전체보기</a></li>
