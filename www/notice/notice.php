...
elseif($jb_code == "100"){ //채용정보
	$dep1 = "2";$dep2 = "2-1";$dep3 = "2-1-4";$page_sub_title = "채용정보"; //다른스킨 04.html
}
elseif($jb_code == "240"){ //질환정보
	$dep1 = "2";$dep2 = "2-0";$dep3 = "2-0-7";$page_sub_title = "질환정보";
}
...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="sub-bnnr">
				<?if($jb_code == "100"){?>
				<img src="/resource-pc/images/subBnnr14.png" alt="">
				<?}else{?>
				<img src="/resource-pc/images/subBnnr13.png" alt="">
				<?}?>
				<h2>
