...
<?
			if ($rst) {
				$C_Func->put_msg_and_go ("회원가입이 완료되었습니다", $GP -> SERVICE_DOMAIN . "/");
			}else{
		...
		case "MEM_MODIFY":
			...
			$C_Func -> put_msg_and_go('회원정보가 수정 되었습니다.', '/mypage/mypage01.html');
			exit();
		break;
		...
		case "MEM_PASS_CH" :
			...
			$C_Func -> put_msg_and_go('비밀번호가 변경 되었습니다.',  '/mypage/mypage02.html');			
			exit();
		break;
